            ...
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="p-5">
                        ...
                        <div>
                            <div class="flex items-center justify-center px-2 py-1 m-1 font-medium text-green-100 bg-green-700 border border-green-700 rounded-md ">
                                <div slot="avatar">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="bg-gray-100 border-b">
                                                ...
                                                <td class="px-6 py-4 text-sm font-light text-gray-900 whitespace-nowrap">
                                                    <div class="flex justify-evenly">
                                                        <div>
                                                            <a href="{{ route('vendors.edit', $vendor->id) }}"><i class="text-lg fa-solid fa-pen-to-square"></i></a>
                                                        </div>
                                                        <div>
                                                            <form method="POST" action="{{ route('vendors.destroy', $vendor->id) }}">
                                                                ...
                                                                @method('DELETE')
                                                                <button type="submit">
                                                                    <i class="text-lg fa-solid fa-trash" style="color: #fa0000;"></i>
                                                                </button>
                                                            </form>
